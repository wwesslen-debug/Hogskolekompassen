...
export function getLiveDataStatus() {
  ...
  const schoolType = hasTable("susa_sync_state")
    ...
    : "HS";
  return { ready: true, eventCount, linkedCount, linkRate: eventCount ? Number((linkedCount / eventCount * 100).toFixed(1)) : 0, providerCount, periods, lastSync, schoolType, sqliteDisabled };
}
