...
export function buildMatchResult(profileResult, programs, selectedPriorities = [], selectedDealBreakers = [], selectedInterests = []) {
  ...
  return {
    ...
    matchModel: {
      ...
      explanation: "Totalmatchningen kombinerar intressen, studiestil, arbetssätt och framtidsmål. De tre valda intresseområdena kan ge en liten boost, prioriteringar kan finjustera resultatet och deal-breakers kan ge tydliga avdrag.",
    },
  };
}
